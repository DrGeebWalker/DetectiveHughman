...
<html>
	...
	<body onload="hasArtTwo()">
		<h1 style="text-align:center"> Detective Hughman and the Art Gallary Murder </h1>
		
		<img id = "img" src="locations/hydrapainting.jpg" class="location"/>

		<div class="plaqueTwo" id="plaq" style="display:none" onclick="artInv()"></div>
		
		<div class="added-item" id="takeArt" style="display:none">
			<p>Self-Portrait by Hydra Bass</p>
			<br>
			<br>
			<p>Have Successful Children is the secret to Success</p>
			<br>
			<p>Detective Hughman: She seems like she was....confident.</p>
			<br>
			<br>
			<p> Self-Portrait Added to Inventory</p>
			<br>
			<br>
			<button onclick="addArtTwo()">Continue</button>
		</div>
