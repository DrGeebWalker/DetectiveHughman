...
<html>
	<head>
		...
		<script>
			...
			function millipedeExist(){
				const helditems = "<available_items/>".split(" ");
				if(!helditems.includes("MILLIPEDE")){
	...
	<body onload="millipedeExist()">
		<h1 style="text-align:center"> Detective Hughman and the Art Gallary Murder </h1>
		
		
		<img id = "img" src="locations/heatherpainting.jpg" class="location"/>
		<div class="milli" id="mili"  style="display:none" onclick="addMill()"></div>
		
		<div class="dialogue-block" id="foundMilli" style="display:none">
			<p>Detective Hughman: A millipede!</p>
			<br>
			<p>Detective Hughman: ...... </p>
			<br>
			<br>
			<p>Millipede added to inventory</p>
			<br>
			<p>Detective Hughman: I should bring this guy outside when I finish this case.</p>
			<p><button onclick="addMillipede()">Continue</button></p>
		</div>
		
		<div class="side-menu" id="side-bar">
			<p>Detective Hughman: Weird, there's no plaque on this one.</p>
			<br>
			<br>
